...
// MS11-MS15 façade: the original solver/src/motion_smooth_solver.cpp
// (360 LOC, eight independent responsibilities) was split into:
//   - motion_smooth_sample_points       (MS11) — IsMotionSmoothSpatialProperty,
//                                                SegmentEndpointValueOrSample,
//                                                MotionSmoothSourceKeyTimes,
//                                                MotionSmoothRawPoints,
//                                                MotionSmoothInterpolatedVector
//   - motion_smooth_bezier_ease         (MS12) — ApplyMotionSmoothBezierEase
//   - motion_smooth_endpoint_keys       (MS13) — MotionSmoothEndpointKeys
//   - motion_smooth_spatial_trajectory  (MS14) — MotionSmoothSpatialTrajectoryKeys
